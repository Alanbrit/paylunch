...
@section('content')
    ...
    <form class="w-full" action="{{ route('user.store')}}" method="post">
        @csrf
        <div class="flex flex-wrap mb-2">
            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-1">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="name" value="{{ old("name","") }}">
            </div>

            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-1">
                <label for="" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Apellidos</label>
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="apellidos" value="{{ old("apellidos","") }}">
            </div>

            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-1">
                <label for="" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Numero telefonico</label>
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="numero" value="{{ old("numero","") }}">
            </div>

            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-1">
                <label for="" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Segundo numero telefonico</label>
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="numero_2" value="{{ old("numero_2","") }}">
            </div>

            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-1">
                <label for="" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Saldo</label>
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="saldo" value="{{ old("saldo","") }}">
            </div>

            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-1">
                <label for="" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Username</label>
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="email" value="{{ old("email","") }}">
            </div>

            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-1">
                <label for="" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Contraseña</label>
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="password" value="{{ old("password","") }}">
            </div>
